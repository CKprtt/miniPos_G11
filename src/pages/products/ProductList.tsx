...
export default function ProductList() {
  ...
  const filteredProducts = products.filter((p) => {
    const matchCategory =
      selectedCategory === "all" || normalizeCategory(p.category) === selectedCategory;
        ...
        <div className="layout-container">
          ...
          <aside className="sidebar">
            ...
            <nav className="menu-list">
              <div className={`menu-item ${isActive("/home")}`} onClick={() => history.push("/home")}>
                <IonIcon icon={homeOutline} /><span>หน้าหลัก</span>
              </div>
              <div className={`menu-item ${isActive("/products")}`} onClick={() => history.push("/products")}>
                <IonIcon icon={cubeOutline} /><span>สินค้า</span>
              </div>
              <div className={`menu-item ${isActive("/pos")}`} onClick={() => history.push("/pos")}>
                <IonIcon icon={cartOutline} /><span>ขาย</span>
              </div>
              <div className={`menu-item ${isActive("/sales")}`} onClick={() => history.push("/sales/history")}>
                <IonIcon icon={barChartOutline} /><span>สรุปยอดขาย</span>
              </div>
            </nav>
          ...
          >
            <div className="mobile-menu-content" onClick={(e) => e.stopPropagation()}>
              ...
              <nav className="menu-list mobile">
                ...
                <div className={`menu-item ${isActive("/products")}`} onClick={() => navigate("/products")}>
                  <IonIcon icon={cubeOutline} /><span>สินค้า</span>
                </div>
                <div className={`menu-item ${isActive("/pos")}`} onClick={() => navigate("/pos")}>
                  <IonIcon icon={cartOutline} /><span>ขาย</span>
                </div>
                <div className={`menu-item ${isActive("/sales")}`} onClick={() => navigate("/sales/history")}>
                  <IonIcon icon={barChartOutline} /><span>สรุปยอดขาย</span>
                </div>
              </nav>
                  ...
                  <div className="product-card" key={p.id}>
                    ...
                    <div className="card-body">
                      ...
                      <button
                        ...
                        onClick={() => history.push(`/products/edit/${p.id}`)}
                      >
                        แก้ไขรายการ
                      </button>
                    </div>
