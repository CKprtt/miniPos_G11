    ...
    <>
      ...
      <div className="order-tabs">
        {[
          ...
          <button
            key={t.value}
            className={`tab-btn ${orderType === t.value ? "active" : ""}`}
      ...
      <div className="payment-methods">
        {[
          ...
          <button
            key={m.value}
            className={`pay-method-btn ${paymentMethod === m.value ? "active" : ""}`}
                    ...
                    return (
                      <div className="pos-card" key={p.id}>
                        <div className="pos-card-img">
                          <img
                            src={p.photo || "https://via.placeholder.com/300x200?text=No+Image"}
                            alt={p.name}
                          />
                        </div>
