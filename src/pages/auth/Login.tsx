        ...
        <div className="login-container">
          <div className="login-wrapper">
            <div className="login-left">
              ...
              <a href="/register" className="btn-link-register" onClick={() => history.push("/register")}>
                ลงทะเบียน
              </a>
            </div>
            ...
            <div className="login-right">
              ...
              <div className="input-box">
                ...
                <span
                  ...
                  style={{ color: password.length < 6 ? "#D64545" : "#59AC77" }}
                >
                  {getPasswordHint()}
                </span>
              </div>
...
>
  ...
  ยังไม่มีบัญชี?{" "}
  <span
    style={{ cursor: "pointer", color: "#59AC77", fontWeight: 500 }}
